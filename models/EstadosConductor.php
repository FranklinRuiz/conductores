...
/**
 * This is the model class for table "estados_conductor".
 *
 ...
 */
class EstadosConductor extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(Conductores::className(), ['id_estado_conductor' => 'id_estado_conductor']);
    }
}
