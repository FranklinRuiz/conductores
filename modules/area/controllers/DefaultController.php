...
//        $length = ($perpage * $page) - 1;
        ...
        foreach ($result as $k => $row) {
            $data[] = [
                ...
                "accion" => '<button class="btn btn-sm btn-light-success font-weight-bold mr-2" onclick="funcionEditar(' . $row["id_area"] . ')"><i class="flaticon-edit"></i>Editar</button>
                             <button class="btn btn-sm btn-light-danger font-weight-bold mr-2" onclick="funcionEliminar(' . $row["id_area"] . ')"><i class="flaticon-delete"></i>Eliminar</button>',
            ];
        }
